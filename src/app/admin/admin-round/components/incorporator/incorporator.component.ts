...
import { IIncorporator } from './IIncorporator';

@Component({
  selector: 'admin-round-incorporator',
  templateUrl: './incorporator.component.html',
  styleUrls: ['./incorporator.component.css']
})

export class RoundIncorporatorComponent {
  @Input() incorporator: IIncorporator = null;
