...
@Component({
  selector: 'app-round-investiments-real-state-details',
  templateUrl: './round-investiments-real-state-details.component.html',
  styleUrls: ['./round-investiments-real-state-details.component.css']
})
export class RoundInvestimentsRealStateDetailsComponent implements OnInit {
